...
public:
    ...
    void Area()
    {
        ...
        for (int i = 0; i < 100; i++) // Analizar que el area del objeto no coincida con el del otro
        {
            sprite.getPosition() + sf::Vector2f(i, i); // Posicion inicial de la bala
        }
    }
    ...
    while (window.isOpen()) // Mientras la ventana esté abierta
    {
        ...
        for (int x = 0; x < 100; x++) // Analizar que el area del objeto no coincida con el del otro
        {
            for (int y = 0; y < 100; y++)
            {
                for (i2 = 0; i2 <i; i2++)
                {
                    if (balas[i2].getPosition()== a1.getPosition() + sf::Vector2f(x, y)) // Si la bala choca con el asteroide 1...
                        {
                        ...
                        if (balas[i2].getPosition() == a2.getPosition() + sf::Vector2f(x, y)) // Si la bala choca con el asteroide 2...
                        {
                        ...
                        if (balas[i2].getPosition()== a2.getPosition() + sf::Vector2f(x, y)) // Si la bala choca con el asteroide 3...
                        {
